...
pub async fn get_version_index(neo4j: &neo4rs::Graph, version_id: impl Into<String>) -> Result<Option<String>, DatabaseError> {
    Ok(triple::find_one(neo4j, indexer_ids::EDIT_INDEX_ATTRIBUTE, version_id, indexer_ids::INDEXER_SPACE_ID, None)
        .send()
        .await?
