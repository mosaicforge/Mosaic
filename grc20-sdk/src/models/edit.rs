use grc20_core::{
    ids, indexer_ids,
    mapping::{entity_node::EntityNodeRef, Entity, Relation},
    system_ids,
};
...
impl Edits {
    ...
    pub fn new(space_id: impl Into<String>, edit_id: impl Into<String>) -> Relation<Self, EntityNodeRef> {
...
impl ProposedEdit {
    ...
    pub fn new(proposal_id: impl Into<String>, edit_id: impl Into<String>) -> Relation<Self, EntityNodeRef> {
