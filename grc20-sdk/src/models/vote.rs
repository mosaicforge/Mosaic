...
use grc20_core::{
    ids, indexer_ids,
    mapping::{self, entity_node::EntityNodeRef, Relation, TriplesConversionError},
};
...
impl VoteCast {
    ...
    pub fn new(account_id: &str, proposal_id: &str, vote_type: VoteType) -> Relation<Self, EntityNodeRef> {
        Relation::new(
