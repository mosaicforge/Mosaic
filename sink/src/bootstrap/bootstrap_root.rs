...
use sdk::{network_ids, pb::ipfs, relation::create_relationship, system_ids, ids::create_geo_id};
...
// pub fn name_ops() -> impl Iterator<Item = ipfs::Op> {
//     NAMES.iter().map(|(id, name)| 
//         ipfs::Op {
//             r#type: ipfs::OpType::SetTriple,
//             triple: Some(ipfs::Triple {
//                 entity: id.to_string(),
...
// pub fn attribute_ops() -> impl Iterator<Item = ipfs::Op> {
//     ATTRIBUTES.iter().flat_map(|(attribute_id, _)| {
//         // create_relationship(attribute_id, system_ids::ATTRIBUTE, system_ids::TYPES, None)
//         std::iter::once(ipfs::Op {
//             r#type: ipfs::OpType::CreateRelation,
//             relation: Some(ipfs::Relation {
//                 id: create_geo_id(),
//                 r#type: system_ids::TYPES.to_string(),
//                 from_entity: attribute_id.to_string(),
//                 to_entity: system_ids::ATTRIBUTE.to_string(),
//                 index: "a0".to_string(),
//             }),
//             ..Default::default()
//         })
...
// pub fn attribute_value_type_ops() -> impl Iterator<Item = ipfs::Op> {
...
//             relation: Some(ipfs::Relation {
//                 id: create_geo_id(),
//                 r#type: system_ids::VALUE_TYPE.to_string(),
//                 from_entity: attribute_id.to_string(),
//                 to_entity: value_type_id.to_string(),
//                 index: "a0".to_string(),
//             }),
//             ..Default::default()
//         })
...
// pub fn type_ops() -> impl Iterator<Item = ipfs::Op> {
...
//                 id: create_geo_id(),
//                 r#type: system_ids::TYPES.to_string(),
//                 from_entity: type_id.to_string(),
//                 to_entity: system_ids::SCHEMA_TYPE.to_string(),
//                 index: "a0".to_string(),
//             }),
//             ..Default::default()
//         })
...
// pub fn root_space_type() -> impl Iterator<Item = ipfs::Op> {
//     // create_relationship(
...
//     // )
//     std::iter::once(ipfs::Op {
//         r#type: ipfs::OpType::CreateRelation as i32,
//         relation: Some(ipfs::Relation {
//             id: create_geo_id(),
//             r#type: system_ids::TYPES.to_string(),
//             from_entity: constants::ROOT_SPACE_ID.to_string(),
//             to_entity: system_ids::SPACE_CONFIGURATION.to_string(),
//             index: "a0".to_string(),
//         }),
//         ..Default::default()
//     })
...
// pub fn type_schema_ops() -> impl Iterator<Item = ipfs::Op> {
...
//             // })
//             .flat_map(|attribute_id| ipfs::Op {
//                 r#type: ipfs::OpType::CreateRelation,
//                 relation: Some(ipfs::Relation {
//                     id: create_geo_id(),
//                     r#type: system_ids::ATTRIBUTES.to_string(),
//                     from_entity: type_id.to_string(),
//                     to_entity: attribute_id.to_string(),
//                     index: "a0".to_string(),
//                 }),
//                 ..Default::default()
//             })
